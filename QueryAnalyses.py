...
class QueryAnalyses:
    def __init__(self, cursor, uploader):
        self.cursor = cursor
    ...
    def getSortChems(self):
        ...
        sqlSort = "SELECT sort_chem, ignore_yes, aqualog_yes, doc_isotopes_yes, elementar_yes, scan_yes, ic_yes, icp_yes, lachat_yes, no3_isotopes_yes, srp_yes, water_isotopes_yes FROM sort_chems;"
